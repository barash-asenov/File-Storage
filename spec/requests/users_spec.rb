...
RSpec.describe 'Users API', type: :request do
  ...
  describe 'POST /api/users' do
    ...
    context 'when invalid request' do
      ...
      it 'returns failure message' do
        expect(json['message'])
          .to match(/Validation failed: Password can't be blank, Name can't be blank, Username can't be blank, Username is invalid, Email can't be blank, Password digest can't be blank/)
      end
    end
  end
end
